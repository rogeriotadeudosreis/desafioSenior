...
public class DesafioApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Item item01 = new Item(null, 1, 1500.0, prod1, 1500.0);
        Item item02 = new Item(null, 1, 150.0, prod2, 1500.0);
        List<Item> lista01 = new ArrayList<>();
        lista01.add(item01);
        lista01.add(item02);

        Item item03 = new Item(null, 1, 3000.0, prod3, 3000.0);
        Item item04 = new Item(null, 1, 150.0, prod4, 150.0);
        List<Item> lista02 = new ArrayList<>();
        lista02.add(item03);
        lista02.add(item04);

        Item item05 = new Item(null, 1, 1000.0, prod5, 1000.0);
        Item item06 = new Item(null, 1, 150.0, prod6, 150.0);
